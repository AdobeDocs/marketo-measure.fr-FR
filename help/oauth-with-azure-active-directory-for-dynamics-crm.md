...
1. Cliquez sur **[!UICONTROL Enregistrements des applications]** dans le menu de gauche.
   ...
   ![1. Cliquez sur Enregistrements des applications dans le menu de gauche.](assets/microsoft-guide-2.png)

1. Cliquez sur **[!UICONTROL Nouvel enregistrement]** dans la partie supérieure.

   ![1. Cliquez sur Nouvel enregistrement dans la partie supérieure.](assets/microsoft-guide-3.png)
...
1. Cliquez sur **[!UICONTROL Authentification]** dans le menu de gauche.
   ...
   ![1. Cliquez sur Authentification dans le menu de gauche.](assets/microsoft-guide-4.png)
...
1. Dans l’onglet Autorisations , cliquez sur **[!UICONTROL Accorder le consentement administrateur pour (nom de l’instance)]**.
   ...
   ![1. Dans l’onglet Autorisations , cliquez sur Accorder le consentement administrateur pour (instance](assets/microsoft-guide-8.png)

1. Cliquez sur **[!UICONTROL Accepter]**.

   ![1. Cliquez sur Accepter.](assets/microsoft-guide-9.png)
...
1. Lors de la première configuration de votre connexion Dynamics, suivez les étapes 1 à 5 de la section « CRM en tant que fournisseur de données » dans [cet article](/help/microsoft-dynamics-crm-installation-guide.md).
