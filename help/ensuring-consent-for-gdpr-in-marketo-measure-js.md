---
description: Indique comment configurer Bizible.js pour attendre le consentement de l’utilisateur pour le RGPD avant de définir des cookies ou d’envoyer des données
