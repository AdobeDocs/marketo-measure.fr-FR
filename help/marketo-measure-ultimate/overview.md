...
![Diagramme d’architecture présentant le flux de données et les connexions des niveaux Marketo Measure 1 à 3](assets/marketo-measure-ultimate-overview-1.png)

**[!DNL Marketo Measure Ultimate]**

![Diagramme d’architecture présentant l’intégration de Marketo Measure Ultimate avec AEP](assets/marketo-measure-ultimate-overview-2.png)
...
![Diagramme de flux de données présentant l’importation de données B2B via la plateforme AEP](assets/marketo-measure-ultimate-overview-3.png)
...
![Interface des paramètres de devise par défaut avec l’option de devise USD](assets/marketo-measure-ultimate-overview-4.png)
...
![Configuration du mappage Sandbox présentant les relations entre les jeux de données et les flux de données](assets/marketo-measure-ultimate-overview-5.png)
...
![Interface de mappage d’étape présentant des configurations d’étape intégrées et personnalisées](assets/marketo-measure-ultimate-overview-6.png)
...
![Configuration des règles de point de contact des membres de Campaign par jeu de données](assets/marketo-measure-ultimate-overview-7.png)

![Configuration des règles de point de contact d’activité par jeu de données](assets/marketo-measure-ultimate-overview-8.png)
