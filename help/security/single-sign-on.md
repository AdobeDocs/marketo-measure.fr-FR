...
>[!NOTE]
>Il est probable que les sociétés utilisent différents fournisseurs d’identité (par exemple, Ping Identity, Okta). Les termes utilisés dans les instructions de configuration suivantes et dans l’interface utilisateur peuvent ne pas correspondre exactement à ceux utilisés par votre fournisseur d’identité.
...
![Page Paramètres d’authentification avec l’option Type de connexion SSO personnalisé](assets/single-sign-on-1.png)
...
![Formulaire de configuration SAML avec champs de mappage d’attributs utilisateur](assets/single-sign-on-2.png)
...
![Configuration du mappage des rôles utilisateur avec les options Utilisateur standard et Administrateur](assets/single-sign-on-3.png)
...
![Bouton Tester l’authentification SAML et message de statut de validation](assets/single-sign-on-4.png)
...
![Bouton Enregistrer pour les paramètres d’authentification et le message de confirmation](assets/single-sign-on-5.png)
...
![Écran de confirmation de connexion SSO réussie](assets/single-sign-on-6.png)
...
Menu Configuration de ![Salesforce affichant les rôles sous Gérer les utilisateurs](assets/6.png)
...
![Navigation du menu Paramètres Dynamics vers les rôles de sécurité](assets/7.png)

![Liste des rôles de sécurité Dynamics présentant les options de rôle disponibles](assets/8.png)
...
![Page Utilisateurs affichant les utilisateurs et utilisatrices externes se connectant à Google](assets/9.png)
