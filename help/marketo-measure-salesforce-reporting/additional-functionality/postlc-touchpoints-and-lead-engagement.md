---
description: Points de contact PostLC et engagement des prospects
...
![Enregistrement de lead montrant les points de contact PostLC dans Salesforce](assets/1.png)
...
![Liste de points de contact PostLC limitée à quatre demandes les plus récentes](assets/2.png)
...
1. Saisissez le nombre de points de contact postLC que vous souhaitez intégrer à vos Leads et cliquez sur **[!UICONTROL Enregistrer]**.
   ...
   ![Page des paramètres du lead pour définir la limite de points de contact PostLC](assets/3.png)
...
1. Saisissez le nombre de points de contact postLC que vous souhaitez envoyer à vos contacts et cliquez sur **[!UICONTROL Enregistrer]**.
   ...
   ![Page des paramètres de contact pour définir la limite de point de contact PostLC](assets/4.png)
