---
description: Création  [!DNL Marketo Measure]  conseils sur les types de rapports personnalisés pour les utilisateurs de Marketo Measure
...
1. Accédez à **[!UICONTROL Configuration]** > **[!UICONTROL Créer]** > **[!UICONTROL Types de rapports]** > **[!UICONTROL Nouveaux types de rapports personnalisés]**.
   ...
   ![1. Accédez à Configurer les nouveaux types de rapports de build](assets/new-types-1.png)
...
1. Définissez le type de rapport personnalisé.
   ...
   * [!UICONTROL Déploiement] > [!UICONTROL Statut du déploiement] : déployé
   ...
   ![Statut de déploiement : déployé](assets/new-types-10.jpg)
...
1. Accédez à **[!UICONTROL Configuration]** > **[!UICONTROL Créer]** > **[!UICONTROL Types de rapports]** > **[!UICONTROL Nouveaux types de rapports personnalisés]**.
   ...
   ![1. Accédez à Configurer les nouveaux types de rapports de build](assets/new-types-12.png)
...
1. Définissez le type de rapport personnalisé.
   ...
   * [!UICONTROL Déploiement] > [!UICONTROL Statut du déploiement] : déployé
   ...
   ![Statut de déploiement : déployé](assets/new-types-13.jpg)
...
1. Accédez à **[!UICONTROL Configuration]** > **[!UICONTROL Créer]** > **[!UICONTROL Types de rapports]** > **[!UICONTROL Nouveaux types de rapports personnalisés]**.
   ...
   ![1. Accédez à Configurer les nouveaux types de rapports de build](assets/new-types-8.png)
...
1. Définissez le type de rapport personnalisé.
   ...
   * [!UICONTROL Déploiement] > [!UICONTROL Statut du déploiement] : déployé
   ...
   ![Statut de déploiement : déployé](assets/new-types-14.jpg)
