...
![Tous les clients Marketo Measure qui utilisent Marketo Measure et Salesforce](assets/bizible-guide-1.png)
...
![Points de contact d’attribution des acheteurs avec opportunités](assets/bizible-guide-2.png)
...
**Leads avec points de contact d’acheteur** | Les deux variations suivantes génèrent un rapport sur les leads et leurs points de contact d’acheteur. Bien qu’ils utilisent le même type de rapport de base, ils sont regroupés par mesures différentes, ID de lead par rapport au canal marketing, afin de fournir deux vues principales des données. Ce type de rapport est conçu pour s’ajouter aux rapports funnel. Il est idéal lorsque vous souhaitez découvrir comment vos prospects interagissent avec vos efforts marketing. Avant toute personnalisation, les deux rapports ci-dessous affichent les informations suivantes :

**[!DNL Marketo Measure]101 : Leads par canal** | Une vue d’ensemble de la manière dont vos canaux marketing influencent la création de leads et leurs engagements supplémentaires.
**[!DNL Marketo Measure]101 : Leads par ID** | Affiche l’histoire des leads. Il s’agit d’un rapport beaucoup plus granulaire, présentant chaque lead individuel et ses points de contact d’acheteur associés.

**Leads/contacts avec les points de contact de l’acheteur** | Ces rapports sont généralement appelés rapports [!DNL Marketo Measure]. Ils utilisent l’objet personnalisé [!DNL Marketo Measure] _[!DNL Marketo Measure]Personne_ par opposition à l’objet Lead dans les rapports mentionnés ci-dessus.
...
Lorsque vous connaissez les rapports « _[!DNL Marketo Measure]101..._ », vous pouvez les recréer à partir de types de rapports personnalisés pour répondre à d’autres besoins de création de rapports personnalisés. La création des [[!DNL Marketo Measure] types de rapports personnalisés](/help/marketo-measure-salesforce-reporting/creating-report-types.md) vous permet d’extraire des champs personnalisés que vous pouvez couramment utiliser dans d’autres rapports CRM. Cela vous aidera à passer [!DNL Marketo Measure] rapports au niveau supérieur.
