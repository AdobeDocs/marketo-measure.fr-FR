...
Article d’assistance : [différence entre les points de contact de l’acheteur et les points de contact d’attribution de l’acheteur](/help/configuration-and-setup/getting-started-with-marketo-measure/difference-between-buyer-touchpoints-and-buyer-attribution-touchpoints.md#configuration-and-setup){target="_blank"}
...
Les [modèles d’attribution](/help/introduction-to-marketo-measure/overview-resources/marketo-measure-attribution-models.md){target="_blank"} qui fournissent le meilleur d’insight pour les mesures basées sur les personnes sont les suivants :
