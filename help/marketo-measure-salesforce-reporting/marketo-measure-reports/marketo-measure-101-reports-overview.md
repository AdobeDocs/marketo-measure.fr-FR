...
![Dossier Rapports de points de contact d’acheteur Salesforce dans Marketo Measure 101](assets/bizible-101-reports-overview-1.png)
...
![Exemple de liste de rapports Marketo Measure 101 dans Salesforce](assets/bizible-101-reports-overview-2.png)
...
Lorsque vous connaissez les rapports « _[!DNL Marketo Measure]101..._ », vous pouvez les recréer à partir de types de rapports personnalisés pour répondre à d’autres besoins de création de rapports personnalisés. La création des [[!DNL Marketo Measure] types de rapports personnalisés](/help/marketo-measure-salesforce-reporting/new-report-types/creating-report-types.md) vous permet d’extraire des champs personnalisés que vous pouvez couramment utiliser dans d’autres rapports CRM. Cela vous aidera à passer [!DNL Marketo Measure] rapports au niveau supérieur.
