---
description: Liste des ressources [!DNL Marketo Measure]
...
* [Qu’est-ce que l’attribution marketing ?](/help/marketing-attribution.md)
* [Modèles d’attribution [!DNL Marketo Measure]](/help/attribution-models.md)
...
* [Chargement des dépenses marketing](/help/marketing-spend/marketing-channel-costs.md#uploading-marketing-costs)
...
* [Création de types de rapports personnalisés avec [!DNL Marketo Measure]](/help/marketo-measure-salesforce-reporting/new-report-types/creating-report-types.md) (si vous devez créer des rapports sur des champs Lead/Contact/Opportunité personnalisés)
* [Glossaire  [!DNL Marketo Measure]  champs](/help/glossary.md)

**Dépannage**

* [Octroi  [!DNL Marketo Measure]  l’assistance technique de SFDC](/help/miscellaneous/granting-salesforce-access-to-marketo-measure-support.md)
* Personne-ressource : [[!DNL Marketo] assistance](https://nation.marketo.com/t5/support/ct-p/Support){target="_blank"}
...
* Qu’est-ce que [!DNL Marketo Measure]
...
* Rapport Leads par ID
* Rapport Leads par canal
* Leads/contacts ([!DNL Marketo Measure] personnes) par ID de rapport
* Leads/contacts ([!DNL Marketo Measure] personnes) par rapport à un canal
...
* Configuration du canal en ligne
* Création et modification de règles de canal en ligne
* Mappage [!DNL Salesforce] campagnes aux canaux
