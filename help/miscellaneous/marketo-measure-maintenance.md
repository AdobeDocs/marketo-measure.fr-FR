...
Pour un rappel sur la façon de charger des informations sur les coûts, lisez [cet article](/help/marketing-spend/marketing-channel-costs.md).
...
Pour plus d’informations sur le modèle de machine learning [!DNL Marketo Measure], consultez [cet article](/help/advanced-features/custom-attribution-models/machine-learning-model-faq.md).
