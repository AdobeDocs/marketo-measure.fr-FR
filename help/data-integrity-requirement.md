---
description: '''Exigence [!DNL Marketo Measure]’Intégrité Des Données D’Ultimate - [!DNL Marketo Measure]'''
...
<table style="table-layout:auto">
  ...
  <tbody>
    ...
    <tr>
      <td colspan="7"><strong>Membre de la campagne</strong> (membre de la campagne pour Salesforce, abonnements au programme pour Marketo)</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Oui</td>
      <td>
        <p>E.g. - 333, selon la table de source de données, il s’agit de l’ID de lead ou de l’ID de contact.</p>
