...
| Type d&#39;Interaction | Exemple | Méthode de génération du point de contact |
| ---|---|--- |
...
> [Création de points de contact à partir d’activités de vente](/help/advanced-features/activities-attribution/salesforce-activities-attribution.md)
> [Questions fréquentes sur les activités et mappage des points de contact des activités aux canaux/sous-canaux](/help/advanced-features/activities-attribution/activities-attribution-faq.md)
