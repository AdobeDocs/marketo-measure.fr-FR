...
![Liste des sessions Insights indiquant le nombre de sessions suivies](assets/1.png)
...
![Vue récapitulative des informations avec la position des points de contact et les détails des canaux](assets/2.png)
...
![Liste de sessions Insights mettant en surbrillance l’icône du bécher de test A/B](assets/3.png)
...
![Panneau des détails de la session affichant les pages vues dans une session](assets/4.png)
