---
description: Installation et configuration du package Salesforce - [!DNL Marketo Measure]
title: Installation et configuration du package [!DNL Salesforce]
...
# Installation du package Salesforce{#marketo-measure-salesforce-package-installation}
...
1. À l’aide d’un navigateur incognito, accédez à [Salesforce AppExchange](https://appexchange.salesforce.com/appxListingDetail?listingId=a0N3000000B3KLuEAN){target="_blank"} et connectez-vous.
...
1. Sélectionnez **[!UICONTROL Installation] pour tous les utilisateurs**.
   ...
   ![1. Sélectionnez Installer pour tous les utilisateurs.](assets/bizible-full-1.png)
...
>[!NOTE]
>
>Apprenez-en plus sur les jeux d’autorisations [!DNL Marketo Measure] créés et [la façon dont ils sont utilisés](/help/configuration-and-setup/marketo-measure-permission-sets.md){target="_blank"}.
...
>[!MORELIKETHIS]
>
>* [Vue d’ensemble des autorisations d’intégration](/help/api-connections/integration-permissions-overview.md){target="_blank"}
>
>* [Configuration d’Adobe Admin Console](/help/configuration-and-setup/adobe-admin-console-setup.md){target="_blank"}
