...
1. Cliquez sur **[!UICONTROL Dispositions de page]**.
   ...
   ![Configuration de Salesforce affichant l’option Mises en page sous Campagnes](assets/1-1.jpg)

1. Cliquez sur **[!UICONTROL Modifier]** en regard de la disposition de page que vous souhaitez mettre à jour.

   ![Liste Mises en page de Campaign avec le bouton Modifier en regard du nom de la mise en page](assets/2-1.jpg)
...
1. Dans l’option [!UICONTROL champs], sélectionnez le champ **[!UICONTROL Activer Buyer Touchpoints]** et faites-le glisser à l’emplacement de votre choix sur la page. Ajoutez ensuite les champs **[!UICONTROL Date de début du point de contact]** et **[!UICONTROL Date de fin du point de contact]**.
   ...
   ![Éditeur de mise en page affichant le champ Activer les points de contact de l’acheteur avec les champs Date de début et de fin du point de contact](assets/3-2.png)
...
1. Faites glisser le bouton **[!UICONTROL Mettre à jour en bloc la date du point de contact]** dans votre section de boutons personnalisés.
   ...
   ![Éditeur de mise en page avec le bouton Date de point de contact de mise à jour en bloc dans la section des boutons personnalisés](assets/4-1.jpg)

1. Cliquez sur **[!UICONTROL Enregistrer]**.

   >[!NOTE]
   >Si vous utilisez plusieurs types d’enregistrements de campagne, vous devez mettre à jour les valeurs de liste de sélection pour le champ **[!UICONTROL Activer Buyer Touchpoints]**. Consultez [cet article](/help/channel-tracking-and-setup/offline-channels/configurations-record-types.md) pour obtenir des instructions.
...
1. Faites glisser la page VisualForce **[!UICONTROL Liste connexe Prospect Marketo Measure]** dans votre section de disposition de page.
   ...
   ![Éditeur de mise en page de page de lead avec liste de leads liée à Marketo Measure page VisualForce](assets/5-1.png)
...
Si vous utilisez la fonctionnalité ABM [!DNL Marketo Measure], [cliquez ici pour obtenir des instructions de disposition de page supplémentaires](/help/advanced-features/account-based-marketing/account-based-marketing-overview.md).
...
1. Trier par : Date du point de contact, Ascendant.
   ...
   ![Configuration de la liste liée aux points de contact de l’acheteur avec colonnes et paramètres d’ordre de tri](assets/6.jpg)

1. Développez l’option Boutons et désélectionnez **[!UICONTROL Nouveau]**.

   ![Propriétés de liste associées affichant le bouton Nouveau désélectionné dans la section Boutons](assets/7.png)
...
Si vous utilisez la fonctionnalité ABM [!DNL Marketo Measure], passez en revue les [instructions de disposition de page supplémentaires](/help/advanced-features/account-based-marketing/account-based-marketing-overview.md).
