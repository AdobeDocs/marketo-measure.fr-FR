...
1. Sélectionnez **[!UICONTROL Installation] pour tous les utilisateurs**.
   ...
   Boîte de dialogue d’installation de Salesforce AppExchange pour le package Marketo Measure![](assets/marketo-measure-salesforce-package-installation-and-set-up-1.png)
