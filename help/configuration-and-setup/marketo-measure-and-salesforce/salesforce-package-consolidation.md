...
![Exemple de filtre de rapport utilisant le champ FT du contenu publicitaire V2_EXT](assets/package-consolidation-1.png)
...
![Filtre de rapport équivalent à l’aide de champs de point de contact consolidés](assets/salesforce-package-consolidation-2.png)
