---
description: Guides de configuration de l’accès à Marketo Measure via les profils Adobe Admin Console et la connexion
...
![Lors de l’accès au Adobe Admin Console, votre Marketo Measure s’affiche](assets/adobe-setup-1.png)
