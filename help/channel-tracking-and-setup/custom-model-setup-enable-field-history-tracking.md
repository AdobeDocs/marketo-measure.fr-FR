---
description: Configuration du modèle personnalisé - Activer le suivi de l’historique des champs pour les utilisateurs de Marketo Measure
...
1. Sélectionnez les champs sur lesquels vous souhaitez effectuer le suivi des modifications.
   ...
   ![1. Sélectionnez les champs sur lesquels vous souhaitez effectuer le suivi des modifications.](assets/custom-models-10.png)
