---
description: Conseils d’attribution des activités Salesforce pour les utilisateurs de Marketo Measure
...
![Si vous souhaitez définir une campagne unique pour chaque représentant commercial](assets/activities-attribution-11.png)
...
![Les règles agissent comme un filtre pour nous indiquer quels enregistrements sont](assets/activities-attribution-12.png)
...
![Avec l’installation de votre package, Marketo Measure comprend un Buyer Touchpoint personnalisé](assets/activities-attribution-13.png)
...
![N’oubliez pas de définir des règles différentes pour les tâches ou les événements. Vous](assets/activities-attribution-5.png)
...
>[!MORELIKETHIS]
>
>[FAQ sur l’attribution des activités](/help/channel-tracking-and-setup/activities-attribution-faq.md)
