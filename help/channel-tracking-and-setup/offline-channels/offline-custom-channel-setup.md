...
![Section Créer des canaux présentant l’interface de création de canaux et de sous-canaux](assets/3-2.png)
...
![Mappage de canal incorrect affichant le même type de campagne mappé à différents sous-canaux](assets/4-2.png)
...
![Corriger le mappage des canaux affichant des types de campagne uniques pour différents sous-canaux](assets/5-2.png)
...
![Section Créer des canaux présentant la création de canaux NULL pour les campagnes en ligne](assets/6-2.png)
...
> [Intégration des programmes Marketo Engage](/help/marketo-measure-and-marketo/marketo-engage-programs-integration.md#channel-mapping){target="_blank"}
