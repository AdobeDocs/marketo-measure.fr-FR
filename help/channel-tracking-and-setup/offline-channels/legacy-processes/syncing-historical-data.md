...
![Exemple de règle de synchronisation de campagne Salesforce pour les données historiques](assets/syncing-historical-data-1.png)
...
![Configuration de la liste marketing Dynamics avec le champ Date Buyer Touchpoint](assets/syncing-historical-data-2.png)
