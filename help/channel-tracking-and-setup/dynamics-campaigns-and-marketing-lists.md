---
description: Conseils sur les campagnes Dynamics et les listes marketing pour les utilisateurs de Marketo Measure
...
![Lorsque des leads ou des contacts sont ajoutés directement à une campagne, ils sont saisis](assets/dynamics-lists-1.png)
...
![Marketo Measure ne prend pas en charge les valeurs de réponse personnalisées.](assets/dynamics-lists-2.png)

Voici les valeurs de réponse de stock pour la réponse de la campagne :

![Valeurs de réponse de stock pour la réponse de campagne :](assets/dynamics-lists-3.png)
...
![Marketo Measure ne prend en charge que les listes marketing statiques. Nous n&#39;appuyons pas](assets/dynamics-lists-5.png)
...
![Pour activer une liste marketing pour les points de contact, il existe un paramètre distinct](assets/legacy-processes-10.png)
...
![La date de point de contact d’une liste marketing est généralement le membre de liste créé](assets/dynamics-lists-6.png)
