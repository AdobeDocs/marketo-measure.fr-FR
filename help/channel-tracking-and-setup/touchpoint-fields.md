---
description: Conseils sur les champs de point de contact pour les utilisateurs de Marketo Measure
...
![Dans le menu Paramètres Marketo Measure , accédez aux champs de point de contact](assets/touchpoint-fields-1.png)
...
L’opérateur [!UICONTROL extrait] extrait la valeur d’un champ à partir d’un autre emplacement, tel que : un champ Campagne, un champ Lead ou, dans un cas d’utilisation plus avancé, [extrait les paramètres personnalisés de la page de destination](https://docs.google.com/document/d/1NRViyCsXvPKbCTfGW32Yi2vWBjMDRF7bzkzKj9s2DDA/edit?ts=5e20b482#heading=h.xxwtissvw4){target="_blank"}. Il la place ensuite sur un champ de point de contact (voir [Associer à l’exemple](https://docs.google.com/document/d/1NRViyCsXvPKbCTfGW32Yi2vWBjMDRF7bzkzKj9s2DDA/edit?ts=5e20b482#heading=h.xxwtissvw4){target="_blank"} #2).
...
![Notez que vous utilisez une barre oblique et non une](assets/touchpoint-fields-11.png)
...
![{6} est le nombre de caractères que nous extrayons](assets/touchpoint-fields-12.png)
...
![{6} est le nombre de caractères que nous extrayons](assets/touchpoint-fields-13.png)
...
![Vous avez créé des campagnes pour une promotion de fin d’été](assets/touchpoint-fields-2.png)
...
![Pour extraire le 10, vous devez définir la valeur sur « BZ=\d{2}-\d{2}-\d{2}-\d{2}-(\d{2}) »](assets/touchpoint-fields-3.png)
...
![Il existe des champs distincts sur l’objet Opportunité pour Segments et Gradec](assets/touchpoint-fields-4.png)
...
![Votre configuration ressemblerait à la capture d’écran ci-dessous. Nom Du Segment](assets/touchpoint-fields-6.png)
...
![Vous pouvez exécuter et tester un outil en ligne (https://regex101.com/(https://regex101.com/){target="blank"})](assets/touchpoint-fields-8.png)

![Vous pouvez exécuter et tester un outil en ligne (https://regex101.com/(https://regex101.com/){target="blank"})](assets/touchpoint-fields-9.png)
