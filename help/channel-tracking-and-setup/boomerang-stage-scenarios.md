---
description: Conseils sur les scénarios d’évaluation de boomerang pour les utilisateurs de Marketo Measure
...
![Le prospect 1 est ensuite converti en contact avec une opportunité](assets/boomerang-stages-18.png)
...
![Dans ce scénario, un client a choisi de suivre uniquement le code SQL](assets/boomerang-stages-19.png)
