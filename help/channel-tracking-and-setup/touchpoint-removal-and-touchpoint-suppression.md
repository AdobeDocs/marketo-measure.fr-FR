---
description: Conseils sur la suppression du point de contact et la suppression du point de contact pour les utilisateurs Marketo Measure
...
![Effectuez un choix dans une liste d’opérateurs qui seront associés au suivant](assets/touchpoint-settings-10.png)
...
![Ou, ajoutez de nouvelles instructions en dehors du groupe pour utiliser la logique « OR »](assets/touchpoint-settings-11.png)
...
![3) Si vos règles deviennent complexes et que vous devez recréer des groupes](assets/touchpoint-settings-6.png)
...
![Si vous faites une erreur, ne vous inquiétez pas. Vous pouvez supprimer des lignes individuelles](assets/touchpoint-settings-7.png)
...
Pour terminer, [!UICONTROL  Enregistrer et traiter ] vos règles. Si vous apportez de nombreuses modifications, veillez à les enregistrer au fur et à mesure. [!DNL Marketo Measure] ne commencera pas réellement à supprimer vos points de contact tant que vous n’aurez pas cliqué
