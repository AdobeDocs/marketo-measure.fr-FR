---
description: Configuration de Doubleclick Campaign Manager Guide d’affichage et d’attribution pour les utilisateurs de Marketo Measure
...
>[!NOTE]
>
>Si vous utilisez l’intégration [!DNL Marketo Measure] et [!DNL DoubleClick Campaign Manager], nous avons besoin d’une connexion [API](/help/api-connections/integrated-ad-platforms.md) afin de pouvoir télécharger les détails des campagnes et des contenus publicitaires pour résoudre les annonces.
...
Pour plus d’informations sur la fonctionnalité [!DNL Marketo Measure] Afficher via l’attribution, consultez la [FAQ sur l’affichage via l’attribution de Marketo Measure](/help/channel-tracking-and-setup/marketo-measure-view-through-attribution-faq.md).
...
1. Une fois ajouté, vérifiez que les délimiteurs sont mappés comme suit. Cette opération doit être automatique une fois la balise appliquée :
   ...
   v = %eadv! [!DNL Expand] ID publicitaire\
   ...
   ![n = %n Macro à nombres aléatoires](assets/view-attribution-1.png)
