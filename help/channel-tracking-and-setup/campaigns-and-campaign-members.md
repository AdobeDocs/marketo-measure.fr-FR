---
description: Conseils sur les campagnes et les membres de campagne pour les utilisateurs de Marketo Measure
...
![Si vous utilisiez une plateforme d’automatisation du marketing avant Marketo Measure](assets/dynamics-lists-2.png)
...
![La date de mise à jour en bloc du point de contact est incluse dans le Marketo installé](assets/dynamics-lists-5.png)
...
![Une fois la date et l’heure définies, cliquez sur Mettre à jour la sélection](assets/dynamics-lists-6.png)

## Coûts de campagne {#campaign-costs}

Pour en savoir plus sur les coûts de campagne, [consultez cet article](/help/crm-campaign-costs.md){target="_blank"}.
