---
description: 'Notes de mise à jour 2023 : conseils pour les utilisateurs de Marketo Measure'
...
La table des URL de l’[entrepôt de données](/help/data-warehouse-schema.md){target="_blank"} inclut désormais un champ de titre de page, en plus des tables de données web.
...
Ces nouveaux tableaux de bord intégrés seront progressivement déployés à partir de la première semaine d’octobre jusqu’à la fin de l’année. Ces nouveaux tableaux de bord seront automatiquement déployés sur vos instances et afficheront des informations sur les produits et des liens vers la documentation.

* [Nouveau guide de découverte du tableau de bord](/help/new-discover-dashboard-guide.md){target="_blank"}
* [Découvrir les bases du tableau de bord](/help/discover-dashboard-basics.md){target="_blank"}
* [Tableau de bord Vue d’ensemble des revenus](/help/revenue-overview-dashboard.md){target="_blank"}
* [Tableau de bord Revenus attribués](/help/attributed-revenue-dashboard.md){target="_blank"}
* [Tableau de bord Retour sur investissement](/help/roi-dashboard.md){target="_blank"}
* [Tableau de bord Passeport](/help/passport-dashboard.md){target="_blank"}
...
Nous supprimerons progressivement nos tâches d’export pour les objets Prospect/contact afin de simplifier notre intégration et d’éliminer la nécessité d’exporter vers des objets standard Salesforce. Les champs dénormalisés répertoriés ci-dessous seront également abandonnés, car les clients peuvent obtenir les mêmes données de leurs objets Point de contact. _&#x200B;**La date limite d’obsolescence est juin 2024.**&#x200B;_
...
![Créer des types de rapports pour les leads et les contacts avec ou sans points de contact.](assets/release-notes-3.png)
...
![Supprimer les champs FT/LC de lead/contact :](assets/release-notes-5.png)

* Ajouter des champs Touchpoint :

![Ajouter des champs de point de contact :](assets/release-notes-4.png)
...
![Le filtre Position du point de contact et tous les filtres qui utilisent les champs FT/LC,](assets/release-notes-2.png)

![Le filtre Position du point de contact et tous les filtres qui utilisent les champs FT/LC,](assets/release-notes-1.png)
...
* Pour rester connecté à Dynamics, installez notre dernière version de package, v6.12. Les anciennes versions `(<v6.12)` ne seront plus prises en charge. Cette mise à jour optimise la création d’enregistrements historiques afin de réduire l’utilisation du stockage.

* La méthode OAuth par jeton d’actualisation a fait son temps et devient obsolète. Consultez [ce guide](/help/oauth-with-azure-active-directory-for-dynamics-crm.md){target="_blank"} pour mettre à jour vos informations d’identification afin de respecter les bonnes pratiques de Microsoft concernant l’utilisation de ClientSecret.
...
[Cet article](/help/configuration-and-setup/salesforce-package-consolidation.md){target="_blank"} comprend des guides sur la recréation de rapports et de tableaux de bord à partir des packages de création de rapports hérités.
...
Le nouveau lien d’installation du package consolidé [se trouve ici](https://login.salesforce.com/packaging/installPackage.apexp?p0=04t1P000000VY6Z){target="_blank"}
