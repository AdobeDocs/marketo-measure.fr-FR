---
description: Explorez le tableau de bord du RSI pour comparer le chiffre d’affaires des coûts et le RSI sur plusieurs canaux, sous-canaux et campagnes au fil du temps
...
![Retour sur investissement réalisé : revenu attribué réalisé divisé par les coûts à la date filtrée](assets/roi-dashboard-9.png)
...
![Quelles sont les pistes marketing (canal, sous-canal ou campagne) qui semblent sous-financées par rapport aux autres ?](assets/roi-dashboard-5.png)
