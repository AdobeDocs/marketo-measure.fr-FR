...
La table des URL de l’[entrepôt de données](/help/data-warehouse/data-warehouse-schema.md){target="_blank"} inclut désormais un champ de titre de page, en plus des tables de données web.
...
* [Nouveau guide du tableau de bord Discover](/help/marketo-measure-discover-ui/new-discover-dashboard-guide.md){target="_blank"}
* [Bases du tableau de bord Discover](/help/marketo-measure-discover-ui/discover-dashboard-basics.md){target="_blank"}
* [Tableau de bord Vue d’ensemble des revenus](/help/marketo-measure-discover-ui/revenue-overview-dashboard.md){target="_blank"}
* [Tableau de bord Revenus affectés](/help/marketo-measure-discover-ui/attributed-revenue-dashboard.md){target="_blank"}
* [Tableau de bord Retour sur investissement](/help/marketo-measure-discover-ui/roi-dashboard.md){target="_blank"}
* [Tableau de bord Passeport](/help/marketo-measure-discover-ui/passport-dashboard.md){target="_blank"}
...
Configuration du type de rapport Salesforce ![pour les leads/contacts avec points de contact](assets/release-notes-2023-1.png)
...
![Colonnes de rapport mettant en surbrillance les anciens champs Lead et Contact FT/LC à supprimer](assets/release-notes-2023-2.png)

* Ajouter des champs Touchpoint :

![Colonnes de rapport présentant les champs de point de contact à ajouter à la place des champs FT/LC](assets/release-notes-2023-3.png)
...
![Exemple de configuration du filtre Position du point de contact](assets/release-notes-2023-4.png)

![Filtre de champ de date mis à jour vers les champs basés sur les points de contact](assets/release-notes-2023-5.png)
