---
description: Guide d’installation CRM [!DNL Microsoft Dynamics]
...
![Écran d’importation des solutions Dynamics CRM avec le bouton Importer](assets/1.png)
...
![Assistant d’import de solution affichant la sélection de package](assets/2.png)

![Écran de confirmation de l’import de la solution](assets/3.png)
...
![Écran de configuration des rôles de sécurité Dynamics affichant les autorisations](assets/4.png)
...
1. Pour chaque entité, accédez à l’éditeur de formulaire. Vous pouvez y accéder dans **[!UICONTROL Paramètres]** > **[!UICONTROL Personnalisations]** > **[!UICONTROL Personnaliser le système]** > `[Entity]` > **[!UICONTROL Formulaires]**. Vous pouvez également y accéder dans les paramètres lorsque vous consultez un enregistrement.
   ...
   * Pour configurer les campagnes, vous devez activer l’option « Synchronisation des campagnes » dans **[!UICONTROL CRM]** > **[!UICONTROL Campagnes]**.
   ...
   ![Activation/désactivation de la synchronisation de la campagne dans les paramètres Marketo Measure](assets/5.png)
...
1. Dispositions des pages : ajoutez d’abord une tuile « [!UICONTROL Une colonne] » dans la section où vous voulez que les points de contact (touchpoints) soient placés. Dans cette nouvelle colonne, il est nécessaire d’ajouter une sous-grille à chaque formulaire dans vos entités Compte, Opportunité, Contact et Prospect.
   ...
   ![Éditeur de formulaire affichant la disposition Une section de colonne](assets/6.png)

   ![Composant de sous-grille ajouté à la disposition du formulaire](assets/7.png)
...
Sous-grille Buyer Touchpoint - Leads et contacts
   ...
   ![Boîte de dialogue Propriétés de sous-grille affichant les options de sélection d’objet](assets/8.png)
...
1. Dans votre compte [!DNL Marketo Measure], cliquez sur le menu déroulant **[!UICONTROL Mon compte]** et sélectionnez **[!UICONTROL Paramètres]**.
   ...
   ![Menu déroulant Mon compte de Marketo Measure avec l&#39;option Paramètres mise en surbrillance](assets/microsoft-dynamics-crm-installation-guide-16.png)

1. Sous [!UICONTROL Intégrations] dans le menu de navigation de gauche, cliquez sur **[!UICONTROL Connexions]**.

   ![Page de paramètres avec l’option Connexions dans le volet de navigation de gauche](assets/microsoft-dynamics-crm-installation-guide-17.png)

1. Cliquez sur le bouton **[!UICONTROL Configurer une nouvelle connexion CRM]**.

   ![Page Connexions avec le bouton Configurer une nouvelle connexion CRM](assets/microsoft-dynamics-crm-installation-guide-18.png)

1. À côté de [!UICONTROL CRM Microsoft Dynamics], cliquez sur le bouton **[!UICONTROL Connecter]**.

   ![Options de connexion CRM affichant Microsoft Dynamics CRM avec le bouton Connexion](assets/microsoft-dynamics-crm-installation-guide-19.png)

1. Sélectionnez [!UICONTROL Informations d’identification] ou [!UICONTROL OAuth].

   ![Écran de sélection de la méthode d&#39;authentification CRM Microsoft Dynamics](assets/microsoft-dynamics-crm-installation-guide-20.png)

   >[!NOTE]
   >Pour plus d’informations sur OAuth, consultez [cet article](/help/marketo-measure-and-dynamics/oauth-with-azure-active-directory-for-dynamics-crm.md). Pour toute question sur le processus, contactez votre personne représentante de compte [!DNL Marketo Measure].
...
1. Cliquez sur le bouton **[!UICONTROL Configurer une nouvelle connexion CRM]**.
   ...
   ![Page Connexions affichant le bouton Configurer une nouvelle connexion CRM](assets/microsoft-dynamics-crm-installation-guide-21.png)

1. Sélectionnez la plateforme de votre choix.

   ![Écran de sélection de la plateforme du compte publicitaire avec diverses options de plateforme publicitaire](assets/microsoft-dynamics-crm-installation-guide-22.png)
...
1. Saisissez votre numéro de téléphone. Pour Site web, entrez votre domaine racine principal qui est utilisé pour le suivi de [!DNL Marketo Measure] sur votre site web. Cliquez sur **[!UICONTROL Enregistrer]** lorsque vous avez terminé.
   ...
   ![Page Configuration du compte avec les champs de numéro de téléphone et de site web](assets/microsoft-dynamics-crm-installation-guide-24.png)
