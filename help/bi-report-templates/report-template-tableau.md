...
![Classeur Tableau affichant le bouton Modifier la connexion](assets/marketo-measure-report-template-tableau-1.png)
...
Boîte de dialogue de connexion à ![Snowflake avec le serveur et les champs d’authentification](assets/marketo-measure-report-template-tableau-2.png)
...
![Champ de commande SQL initial pour la spécification du schéma](assets/marketo-measure-report-template-tableau-3.png)
...
![Table des opportunités avec colonnes de taux de conversion](assets/marketo-measure-report-template-tableau-6.png)
...
![Tableau combiné affichant la colonne Type pour l&#39;identification des entités](assets/marketo-measure-report-template-tableau-7.png)
...
![Tableau de mappage des noms de segment affichant les noms de catégorie et personnalisés](assets/marketo-measure-report-template-tableau-8.png)
...
![SQL personnalisé avec catégories de segments renommées](assets/marketo-measure-report-template-tableau-9.png)

L’autre option consiste à renommer les colonnes directement dans le tableau [!DNL Tableau].

![Tableau avec colonnes de segments renommées](assets/marketo-measure-report-template-tableau-10.png)

## Modèle de données {#data-model}

Cliquez sur l’image ci-dessous pour afficher la version agrandie.

[![Diagramme de modèle de données Tableau présentant les relations entre les tables](assets/marketo-measure-report-template-tableau-11.png)](/help/bi-report-templates/assets/tableau-data-model.png){target="_blank"}
...
![Tableau combiné des dimensions Canal et Campagne](assets/marketo-measure-report-template-tableau-12.png)
...
![Champs de calcul de la conversion monétaire dans Tableau](assets/marketo-measure-report-template-tableau-13.png)
...
![Info-bulle affichant les mesures de conversion des devises](assets/marketo-measure-report-template-tableau-14.png)
...
![Définitions de champ dans le modèle Tableau affichant les descriptions](assets/marketo-measure-report-template-tableau-15.png)
