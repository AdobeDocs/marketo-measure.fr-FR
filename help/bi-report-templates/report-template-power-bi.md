...
![Boîte de dialogue native d’approbation de requête dans Power BI](assets/marketo-measure-report-template-power-bi-2.png)
...
![Requêteur affichant les paramètres de filtre de date](assets/marketo-measure-report-template-power-bi-3.png)
...
![L’éditeur de requêtes Power affiche les étapes de transformation appliquées](assets/marketo-measure-report-template-power-bi-4.png)
...
![Boîte de dialogue de sélection des colonnes affichant la configuration des colonnes supprimées](assets/marketo-measure-report-template-power-bi-5.png)
...
![Étape Colonnes renommées affichant les mappages de nom de colonne](assets/marketo-measure-report-template-power-bi-6.png)
...
![Table de mappage des noms de segments dans Power Query](assets/marketo-measure-report-template-power-bi-7.png)
...
![Tableau des points de contact présentant la transformation des ID sensible à la casse](assets/marketo-measure-report-template-power-bi-8.png)

![Table Campaign avec colonne d’identifiant de jointure pour la correspondance sensible à la casse](assets/marketo-measure-report-template-power-bi-9.png)
...
![Table des opportunités avec colonne des taux de conversion d’entreprise](assets/marketo-measure-report-template-power-bi-10.png)
...
![Table des taux de conversion avec des lignes de date développées](assets/marketo-measure-report-template-power-bi-11.png)

## Modèle de données {#data-model}

Cliquez sur l’image ci-dessous pour afficher la version agrandie.

[![Diagramme de modèle de données Power BI montrant les relations entre les tables](assets/marketo-measure-report-template-power-bi-12.png)](/help/bi-report-templates/assets/power-bi-data-model.png){target="_blank"}
...
![Formule de conversion monétaire présentant la logique de calcul DAX](assets/marketo-measure-report-template-power-bi-13.png)
...
![Propriétés du tableau affichant les descriptions des définitions](assets/marketo-measure-report-template-power-bi-14.png)

![Définitions de colonne personnalisées dans le modèle de données](assets/marketo-measure-report-template-power-bi-15.png)

![Définitions des mesures avec des formules DAX](assets/marketo-measure-report-template-power-bi-16.png)

Pour afficher les définitions des colonnes provenant directement de [!DNL Snowflake], reportez-vous à la [documentation de l’entrepôt de données](/help/data-warehouse/data-warehouse-schema.md){target="_blank"}.
