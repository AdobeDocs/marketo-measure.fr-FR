---
description: Introduit l’interface de tableau de bord Discover, les filtres, les actions d’exploration, le filtrage croisé, les exportations et le mode de thème
...
![Activez l’analyse en cliquant sur la seule flèche vers le bas, mise en surbrillance par un gris](assets/discover-basics-8.png)

Pour analyser un champ à la fois, activez l’icône d’analyse et sélectionnez un élément visuel, tel qu’une barre.

![Pour analyser un champ à la fois, activez l’analyse](assets/discover-basics-2.gif)

Utilisez l’icône d’analyse à double flèche pour passer au niveau hiérarchique suivant.

![Utilisez l’icône d’analyse à double flèche pour accéder à la hiérarchie suivante](assets/discover-basics-1.gif)
...
![Pour exporter les données sous-jacentes d’un visuel, pointez sur son coin supérieur droit](assets/discover-basics-6.gif)
...
![La sélection d’une valeur ou d’un libellé d’axe dans une visualisation entraîne un filtrage croisé](assets/discover-basics-3.gif)
...
![Les info-bulles fournissent des détails supplémentaires sur les données affichées. Pointez sur un visuel](assets/discover-basics-4.gif)
