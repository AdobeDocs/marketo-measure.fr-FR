...
![Chronologie du parcours client présentant quatre points de contact jalonnés : premier contact, création de lead, création d’opportunité et conclusion de l’appel](assets/1-1.png)
...
![Diagramme de modèle Première touche présentant un crédit d’attribution de 100 % au canal Adwords](assets/2.png)
...
![Diagramme de modèle de création de leads présentant un crédit d’attribution de 100 % au canal LinkedIn](assets/3.png)
...
![Diagramme de modèle en U montrant 50 % de crédit à Adwords et 50 % à LinkedIn](assets/4.png)
...
![Diagramme de modèle en W montrant 30 % de crédit chacun aux points de contact FT, LC et OC, et 10 % aux points de contact intermédiaires](assets/5.png)
...
![Diagramme de modèle de chemin complet montrant 22,5 % de crédit chacun aux points de contact FT, LC, OC et CW, et 10 % aux points de contact intermédiaires](assets/6.png)
