...
Ces modèles n’ont pas tous la même complexité. Première touche et création de pistes sont des modèles simples à une seule touche. Les quatre autres sont des modèles multi-touch plus complexes. La structure des modèles d’attribution de Marketo Measure reflète les quatre principaux points de contact qui jalonnent le parcours client :
...
Le modèle Première touche se concentre uniquement sur la première interaction d’un prospect avec votre entreprise. Il attribue 100 % du crédit au premier point de contact entre le prospect et votre société, appelé « Premier contact » (FT).
...
Le modèle en U se concentre sur les points de contact FT et LC, Dans ce modèle, les points de contact FT et LC reçoivent chacun 50 % du crédit de recettes.
...
Le modèle en chemin complet comprend les quatre jalons. Le FT, la LC, l’OC et la CW reçoivent chacun 22,5 % du crédit de recettes, et les 10 % restants sont répartis à parts égales entre les touches intermédiaires.
