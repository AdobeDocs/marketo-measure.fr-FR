...
![Légende des segments affichant les icônes utilisées par l’administrateur](assets/1.png)
...
![Ajout d’une catégorie et d’un nom de segment dans Marketo Measure](assets/2.png)
...
![Champs d’entrée des règles pour définir un filtre de segment](assets/3.png)
