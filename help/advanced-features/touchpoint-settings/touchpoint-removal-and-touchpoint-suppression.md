...
![Créateur de règles de suppression affichant la logique AND/OR groupée](assets/2.png)
...
![Option de clonage pour dupliquer des groupes de règles de suppression](assets/3.png)
...
![Supprimer les icônes des instructions individuelles et des groupes de règles](assets/4.png)
