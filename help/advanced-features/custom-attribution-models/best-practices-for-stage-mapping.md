...
>[!MORELIKETHIS]
>[La différence entre les étapes Funnel et les étapes de modèle personnalisé](/help/advanced-features/custom-attribution-models/custom-attribution-model-and-setup.md#the-difference-between-funnel-stages-and-custom-model-stages)
