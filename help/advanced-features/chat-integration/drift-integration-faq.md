---
description: FAQ sur l'intégration de Drift - [!DNL Marketo Measure]
...
![Exemple de règle d’activité CRM configurée pour les points de contact de conversation](assets/activity-rule-drift.png)
