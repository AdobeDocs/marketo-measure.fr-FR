...
>[!NOTE]
>[Instructions sur la configuration des étapes de boomerang](/help/advanced-features/boomerang/setting-up-boomerang-stages.md).
...
![Enregistrement d’opportunité affichant uniquement les derniers points de contact d’étape sans boomerang](assets/1.png)
...
![Points de contact Boomerang répertoriés pour plusieurs transitions d’étape MQL et SQL](assets/2.png)
