...
![Mosaïques de KPI du tableau de bord du RSI pour le coût, le chiffre d’affaires attribué et le RSI](assets/roi-dashboard-1.png)
...
![Graphique à barres empilées des coûts et revenus par canal](assets/roi-dashboard-2.png)
...
![Graphique linéaire comparant le RSI réalisé au simple RSI](assets/roi-dashboard-3.png)
...
![Graphique à barres empilées du coût au fil du temps avec commandes de perçage](assets/roi-dashboard-4.png)
...
![Graphique à barres Dépenses marketing par canal](assets/roi-dashboard-5.png)
