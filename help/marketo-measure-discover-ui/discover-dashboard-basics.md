---
description: Découvrez les bases du tableau de bord - [!DNL Marketo Measure] - Produit
...
![Info-bulle Filtres en visuel répertoriant les filtres appliqués](assets/discover-dashboard-basics-3b.png)
...
![Découvrir le tableau de bord affichant les commandes de perçage sur un visuel](assets/discover-dashboard-basics-4.png)
...
![Analyse descendante à un seul niveau activée sur un graphique](assets/discover-dashboard-basics-5.png)

Pour analyser un champ à la fois, activez l’icône d’analyse et sélectionnez un élément visuel, tel qu’une barre.

![Explorer un champ à la fois sur un graphique](assets/discover-dashboard-basics-6.gif)

Utilisez l’icône d’analyse à double flèche pour passer au niveau hiérarchique suivant.

![À l’aide de la double flèche d’exploration vers le bas pour passer à la hiérarchie suivante](assets/discover-dashboard-basics-7.gif)

Utilisez l&#39;icône en forme de branchement pour ajouter un niveau de hiérarchie supplémentaire à votre affichage actuel.

![Ajout d’un niveau de hiérarchie supplémentaire avec l’icône de branchement](assets/discover-dashboard-basics-8.gif)
...
![Accéder avec le bouton droit de la souris aux données détaillées d’un visuel](assets/discover-dashboard-basics-9.gif)
...
![Menu Exporter des données d’un visuel de tableau de bord](assets/discover-dashboard-basics-10.gif)
...
![Activation du mode thème dans un visuel de tableau de bord](assets/discover-dashboard-basics-11.gif)
...
![Filtrage croisé des visuels en sélectionnant une valeur sur un graphique](assets/discover-dashboard-basics-12.gif)
...
![Infobulle pointant affichant des données contextuelles dans un visuel de tableau de bord](assets/discover-dashboard-basics-13.gif)
