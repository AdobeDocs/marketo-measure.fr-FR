...
![Ouvrez le fichier Power BI du modèle de création de rapports Adobe Marketo Measure.](assets/marketo-bi-1.png)
...
![Pour limiter les données importées dans le modèle, chaque table est définie](assets/marketo-bi-2.png)
...
![Quelques transformations ont été appliquées aux données dans Power Query.](assets/marketo-bi-6.png)
...
![La plupart des tables de l’entrepôt de données Marketo Measure contiennent des dimensions dénormalisées](assets/marketo-bi-7.png)
...
![/coller des fonctions et filtrage.](assets/marketo-bi-8.png)

![/coller des fonctions et filtrage.](assets/marketo-bi-11.png)
...
![La table Taux de conversion stockée dans Snowflake contient une période](assets/marketo-bi-9.png)

## Modèle de données {#data-model}

Cliquez sur l’image ci-dessous pour afficher la version agrandie.

[![Cliquez sur l’image ci-dessous pour sa version en taille réelle.](assets/marketo-bi-12.png)](assets/power-model-1.png){target="_blank"}
...
![Les mesures de conversion de devise dans ce modèle remplacent une valeur de 1,0](assets/marketo-bi-13.png)
...
![Des définitions ont été ajoutées au modèle Power BI pour les tables, personnalisées](assets/marketo-bi-15.png)

![Des définitions ont été ajoutées au modèle Power BI pour les tables, personnalisées](assets/marketo-bi-16.png)

![Des définitions ont été ajoutées au modèle Power BI pour les tables, personnalisées](assets/marketo-bi-14.png)
