...
>[!MORELIKETHIS]
>
>* [Utilisation d’un champ de montant du revenu personnalisé](/help/advanced-marketo-measure-features/custom-revenue-amount/using-a-custom-revenue-amount-field.md)
>* [Utilisation du chargeur de données pour mettre à jour le champ de montant personnalisé](/help/advanced-marketo-measure-features/custom-revenue-amount/using-data-loader-to-update-marketo-measure-custom-amount-field.md)
>* [Présentation de la fonctionnalité multidevise](/help/advanced-marketo-measure-features/multi-currency/overview.md)
>* [Paramètres multidevises](/help/advanced-marketo-measure-features/multi-currency/settings.md)
