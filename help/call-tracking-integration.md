---
description: Conseils d’intégration du suivi d’appel pour les utilisateurs de Marketo Measure
...
CallTrackingMetrics doit effectuer des tâches de développement de son côté pour que cela fonctionne. Avec le JavaScript qu’ils placent sur votre site, CallTrackingMetrics peut extraire le `_biz_uid` du cookie [!DNL Marketo Measure]. Cet « BizibleId » est ensuite stocké par CallTrackingMetrics.
...
![Voici un exemple d’enregistrement de tâche avec l’ID Bizible](assets/other-resources-5.png)
