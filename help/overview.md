...
[!DNL Marketo Measure] (anciennement Bizible) fournit aux marketeurs insight les actions de marketing les plus efficaces pour générer du chiffre d’affaires et optimiser le retour sur investissement de leur entreprise. [!DNL Marketo Measure] est une solution d’attribution marketing qui effectue automatiquement le suivi et crée des rapports sur les performances des canaux, en offrant une visibilité sur les canaux qui génèrent le plus d’engagement des clients et en vous permettant d’optimiser vos dépenses marketing en conséquence.
...
![Niveaux Marketo Measure 1-3](assets/marketo-overview-1.png)
...
![Données d’une entité donnée (par exemple, Compte) à partir de données données données spécifiques](assets/marketo-overview-6.png)
...
![Les règles de point de contact des membres de la campagne et les règles de point de contact de l’activité sont spécifiques au jeu de données.](assets/marketo-overview-5.png)

![Les règles de point de contact des membres de la campagne et les règles de point de contact de l’activité sont spécifiques au jeu de données.](assets/marketo-overview-8.png)
