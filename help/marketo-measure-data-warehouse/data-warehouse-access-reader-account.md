---
description: Accès à Data Warehouse - Compte en lecture seule
...
1. Dans [!DNL Marketo Measure], en haut de la page, cliquez sur **[!UICONTROL Mon compte]** > **[!UICONTROL Paramètres]**.
   ...
   ![Menu de navigation de Marketo Measure avec les options Mon compte et Paramètres](assets/data-warehouse-access-reader-account-1.png)

1. Dans le menu de gauche, sous Sécurité, cliquez sur **[!UICONTROL Data Warehouse]**.

   ![Barre latérale des paramètres avec l’option Data Warehouse dans la section Sécurité](assets/data-warehouse-access-reader-account-2.png)

1. Cette page contient le lien vers votre entrepôt de données Snowflake et votre nom d’utilisateur.

   ![Page d&#39;informations Data Warehouse affichant l&#39;URL Snowflake et le nom d&#39;utilisateur](assets/data-warehouse-access-reader-account-3.png)
...
1. Cliquez sur le lien fourni dans l’URL de Snowflake pour accéder à la page de connexion de Snowflake, où vous saisissez votre nom d’utilisateur et votre mot de passe. _Si vous ne disposez pas de votre mot de passe, suivez les étapes ci-dessous pour le réinitialiser_.
   ...
   Page de connexion de ![Snowflake avec champs de nom d&#39;utilisateur et de mot de passe](assets/data-warehouse-access-reader-account-4.png)

1. Une fois connecté, cliquez sur **[!UICONTROL Feuilles de calcul]** en haut de la page.

   Interface de ![Snowflake avec l&#39;option de navigation Feuilles de calcul](assets/data-warehouse-access-reader-account-5.png)
...
1. Les objets de base de données BIZIBLE_ROI_V3 se trouvent sur le côté gauche de l’écran. Saisissez l’entrepôt de données, la base de données et le schéma dans les options de liste déroulante en haut de la fenêtre de requête. Il ne doit y avoir qu’une seule option pour chacune. Vous êtes maintenant prêt à exécuter des requêtes dans l’éditeur de requêtes de Snowflake.
   ...
   ![Éditeur de requêtes Snowflake avec la base de données BIZIBLE_ROI_V3 et les sélecteurs de liste déroulante](assets/data-warehouse-access-reader-account-6.png)
...
Page ![Data Warehouse avec bouton Réinitialiser le mot de passe](assets/data-warehouse-access-reader-account-7.png)

![Affichage du mot de passe temporaire après la réinitialisation du mot de passe](assets/data-warehouse-access-reader-account-8.png)
...
* **Nom de l’entrepôt de données** (pas toujours obligatoire)
  ...
  ![Page d&#39;informations Data Warehouse affichant les détails de la base de données et du nom de l&#39;entrepôt de données](assets/data-warehouse-access-reader-account-9.png)
