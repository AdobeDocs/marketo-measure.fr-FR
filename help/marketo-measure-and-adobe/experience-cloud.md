...
Menu Adobe Experience Cloud ![avec option de sélection Marketo Measure](assets/unified-shell-overview-4.png)
...
![Interface de gestion des domaines présentant les options de configuration des domaines](assets/unified-shell-overview-5.png)
...
![Centre d’aide intégré avec options de recherche et d’assistance](assets/unified-shell-overview-6.png)
...
![Icône de notifications avec indicateurs d’alerte](assets/unified-shell-overview-8.png)

![Panneau de notifications affichant les annonces et les mises à jour de produits](assets/unified-shell-overview-9.png)
...
![Menu Profil avec les options Paramètres Adobe et Mes paramètres](assets/unified-shell-overview-10.png)
...
![Page d’erreur indiquant le problème de connexion à Marketo Measure](assets/unified-shell-overview-11.png)
